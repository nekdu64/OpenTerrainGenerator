...
public abstract class Settings
{
	...
	/**
	 * Creates a setting that represents a block materials.
	 * Warning: you will get an AssertionError later on (during config
	 * reading) if you provide invalid materials.
	 *
	 * @param name          Name of the setting.
	 * @param defaultValue Default values for the setting.
	 * @return The newly created setting.
	 */
	protected static final MaterialSetting MaterialSetting(String name, String defaultValue)
	{
