...
public abstract class CustomObjectConfigFunction<T>
{
	 ...
	 * @return The material.
	 */
	protected final LocalMaterialData readMaterial(String BO3name, LocalMaterialData defaultBlock,String string, IMaterialReader materialReader) throws InvalidConfigException
	{
		return materialReader.readMaterial(string,defaultBlock,BO3name);
	}
